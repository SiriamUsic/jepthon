...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح اوامر الصلاة :\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.صلاة` )\nاكتب الامر مع اسم محافظتك باللغه الانجليزيه للحصول على اوقات الصلاة\n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙CH : @JAVA_tlethon"
)
@jepiq.ar_cmd(
...
@jepiq.ar_cmd(
    pattern="اوامر الجروب الوقتي$",
    command=("اوامر الجروب الوقتي", plugin_category),
)
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح اوامر الجروب الوقتي :\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.جروب وقتي` )\nبكتابة الامر لاضافة جروب وقتي حسب منطقة التي وضعتها .\n- ( `.انهاء جروب وقتي` )\nلانهاء الجروب الوقتي \n- ( `.جروب صورة وقتي` )\nبكتابة الامر لتشغيل الصورة الوقتية للمجموعة حسب منطقة التي وضعتها .\n- ( `.انهاء جروب صورة وقتي` )\n لأنهاء الصورة الوقتية للمجموعة.\n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙CH : @JAVA_tlethon"
)
...
@jepiq.ar_cmd(
    pattern="اوامر جوجل$",
    command=("اوامر جوجل", plugin_category),
)
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح اوامر جوجل :\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.صور +  عدد الصور + نص` )\nللحصول على صور من متصفح جوجل بكتابة الامر وعدد الصور الحد 10 واسم النص \n\n- ( `.استخرج + عربي` ) \n لاستخراج النصوص من الصور التي تحتوي على كلمات عربيه\n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙CH : @JAVA_tlethon"
)
...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        " قائمة اوامر الجهات والاضافة\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.ضيف +  رابط مجموعة` )\n  يستخدم الامر لاخذ اعضاء من مجموعة ثانية واضافتهم في مجموعتك ترسل الامر مع اربط جروب عام في مجموعتك للاضافة \n مثال :  .ضيف https://t.me/TE_GOD \n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙CH : @JAVA_tlethon"
)
