...
async def amireallyalive(event):
    ...
    CAT_IMG = "https://telegra.ph/file/9870433b0c155ecf2ad07.png"
    if CAT_IMG:
        CAT = [x for x in CAT_IMG.split()]
        A_IMG = list(CAT)
        PIC = random.choice(A_IMG)
        cat_caption = f"مبرمج سورس جافا\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
        cat_caption += f"- المبرمج صلاح   :  @Salah_officiall\n"
        cat_caption += f"- المطور بيدو  : @Hk_MB\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
