    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("مطور السورس", "https://t.me/Salah_officiall"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب تلي جود  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/Salah_officiall")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="**لتـنصيب البـوت تفضل الى مجموعة المساعدة ليساعدوك 🧸♥**.",
            buttons=[
                [Button.url("جروب المساعدة ❓", "https://t.me/Te_God")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(event.chat_id,
                                 ...
                                 buttons=[
                                 [Button.inline(
                                     "اسماء انجليزي َِ🛹", data="rozname"),
                                  Button.inline(
                                     "البايو َِ🛹", data="rozpio1")],
                                 [Button.inline(
                                     "الاشهر َِ🛹 ⁦⁩", data="rozmonth"),
                                  Button.inline(
                                     "اسماء قنوات َِ🛹", data="chanlan")]
                                 ])
    else:
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @SR_TeleGod", alert=True)
